...
void MainWindow::on_pushButton_clicked()
{
    if (count == 1) {
        ...
        std::ofstream ofs(filenameAfter, std::ios::binary);
        std::vector<std::string> vecFilenames2;
        std::string paths[3] = {"/home/zuckerberg/Escritorio/Disk 1/B/chunk1.bin", "/home/zuckerberg/Escritorio/Disk 2/B/chunk2.bin", "/home/zuckerberg/Escritorio/Disk 3/B/chunk3.bin"};
        for (int i = 0; i < 3; ++i) {
            vecFilenames2.push_back(paths[i]);
        }
        this->controller->getManager()->join(vecFilenames2, ofs);
        ...
        std::ofstream ofs(filenameAfter, std::ios::binary);
        std::vector<std::string> vecFilenames2;
        std::string paths[3] = {"/home/zuckerberg/Escritorio/Disk 1/C/chunk1.bin", "/home/zuckerberg/Escritorio/Disk 2/C/chunk2.bin", "/home/zuckerberg/Escritorio/Disk 3/C/chunk3.bin"};
        for (int i = 0; i < 3; ++i) {
            vecFilenames2.push_back(paths[i]);
        }
        this->controller->getManager()->join(vecFilenames2, ofs);
